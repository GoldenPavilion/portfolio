    ...
    return(
        <div className="about">
            <div className="about-text">
                <p><b>Hi I'm Cory Stine!</b> I'm a full stack web developer from Baltimore, Maryland with a passionate devotion to curious exploration, creative problem solving and engaged communication. I love the feeling of diving head first into a subject that challenges my pre-existing notions and pushes my capabilities.</p> 
